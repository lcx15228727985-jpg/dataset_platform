...
# 配置
# ==========================================
DATASET_NAME = "/root/asym_pinn_dataset"
TOTAL_SAMPLES = 5000
SEQ_LEN = 5
IMG_SIZE = 224
    ...
    for m_i, m_pts in enumerate(markers):
        ...
        for c_idx in crossings:
            ...
            if 0 < px < img_size and 0 < py < img_size:
                # 🔥 非对称标记：Marker 0 很大 🔥
                radius = 6 if m_i == 0 else 3
                intensity = 255 if m_i == 0 else 180
                cv2.circle(image, (px, py), radius, intensity, -1)
    return image
...
if __name__ == "__main__":
    ...
    metadata = []
    print(f"🚀 生成非对称 PINN 数据集: {TOTAL_SAMPLES} 组...")
